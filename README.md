...
- 2026-06-06　张俊昊：前端接入 Spring Boot，同源托管 web 静态资源（/ 用户端、/admin 后台），前后端联调
- 2026-06-06　林兆永：清理旧 Node 后端代码（server/package/SQLite），统一为 Spring Boot 单体
- 2026-06-07　张俊昊：补充 JUnit/MockMvc 单元与集成测试、接口与性能测试报告，热度接口接入 Redis 缓存
